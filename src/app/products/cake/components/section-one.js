...
import cake_recommend from "../data/recommend";
register();



export default function Cakerecommend(){
    const productId = 2;
  ...
  useEffect(() => {
    ...
    const recommendElements = cake_recommend.map((item, index) => {
        return (
            <swiper-slide>
            ...
            <div className="w-11/12 mx-auto">
                <div className="flex items-center">
                    ...
                    <div className="w-full text-center">
                        ...
                        <h2 className="text-black font-playfairDisplay text-2xl font-bold">Cake</h2>
                    </div>
                    <div className="w-full h-0.5 bg-black"></div>
                </div>
                ...
                <div className="w-full h-full rounded-3xl bg-red-100">
